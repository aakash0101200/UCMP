...
const AppBar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 py-3 backdrop:blur-lg bg-white/20 dark:bg-neutral-900/20 border-b
        ...
        {isOpen && (
          <div className="fixed right-0 z-20 bg-neutral-900 w-full flex flex-col justify-center items-center p-12 lg:hidden">
            <ul className="space-y-4">
              <li>
                <Link to="/" onClick={toggleMenu} className="hover:underline py-4">Home</Link>
              </li>
              <li>
                <Link to="/login" onClick={toggleMenu} className="hover:underline py-4">Login</Link>
              </li>
              <li>
