    ...
    return (
        <div className="p-6 mb-6 bg-neutral-900 rounded-2xl border border-neutral-700 shadow-md">
            ...
            <div className="flex flex-col items-center">
                ...
                {message && (
                    <div className={`mt-6 p-4 rounded-xl w-full text-center text-sm font-medium ${status === 'success' ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'
                        }`}>
                        {message}
                    </div>
                )}
