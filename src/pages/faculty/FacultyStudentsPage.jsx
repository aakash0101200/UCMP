...
export default function FacultyStudentsPage() {
  ...
  return (
    <div className="-mt-6 -mx-6 min-h-[calc(100vh-64px)] bg-[#F9FBFC] dark:bg-[#0D1512] transition-colors duration-300 text-slate-800 dark:text-slate-100 overflow-y-auto w-[calc(100%+3rem)] p-6 space-y-6 pb-24 text-left">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-[#14221C] border border-emerald-200/40 dark:border-emerald-950/60 p-6 rounded-3xl shadow-sm">
        <div>
        ...
        {/* Tab Selector */}
        <div className="flex bg-slate-200/50 dark:bg-[#0D1512]/60 p-1 rounded-2xl border border-slate-200 dark:border-emerald-950/60 w-fit gap-2 shadow-sm">
          <button
